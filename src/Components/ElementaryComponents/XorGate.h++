...
namespace nts {
    /**
     * @class XorGate
     * @brief Class for XorGate Elementary Component
    ...
    class XorGate : public IComponent {
      ...
      public:
        /**
         * @brief XorGate constructor
         */
        XorGate() = default;

        /**
         * @brief Simulate a tick of an XorGate component
         ...
         * @param pin Pin of the XorGate component.
         ...
         */
        static Tristate computeXorOperation(Tristate first, Tristate second);
    };
} // namespace nts
