...
namespace nts {
    /**
     * @class OrGate
     * @brief Class for OrGate Elementary Component
    ...
    class OrGate : public IComponent {
        ...
        std::size_t _lastComputedTick =
            -1; ///< Last computed tick for compare if the value has already been
                ///< computed. In this case, we just return the _prevValue.
        std::size_t _lastSimulatedTick = 0; ///< Last simulated tick.

      public:
        /**
         * @brief OrGate constructor
         */
        OrGate() = default;

        /**
         * @brief Simulate a tick of an OrGate component
         ...
         * @param pin Pin of the OrGate component.
         ...
         */
        static Tristate computeOrOperation(Tristate first, Tristate second);
    };
} // namespace nts
